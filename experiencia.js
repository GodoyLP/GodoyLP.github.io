...
let experiencia1 = new Expereincia("02/2016","04/2016", "Puesto Mantenimiento y soporte técnico en Empresa Nelo Diseño S.A.",
  "Control de equipamiento y reparación.", "Mantenimiento de equipos informático e impresora.", "Conexiones de redes.", "Antivirus.", "Conexiones remotas.");
...
"Creación de inventarios de insumos.","Mantenimiento y reparación de ordenadores personales e impresoras.","Soporte técnico.",);
let experiencia3 = new Expereincia( "02/2017","08/2018",  "Puesto administración aula virtual en forma particular (free lance)",
  "Crear premisos a los estudiantes.",  "Postear material de estudio.",  "Creación de tareas hogareñas.",  "Preparación de material administrativo del docente.",);
let experiencia4 = new Expereincia("02/2018","12/2019","Puesto Clases particulares y soporte técnico en forma particular.",
"Clases didácticas de acuerdo a las necesidades del alumno.","Creación de apuntes de estudio.","Mantenimiento de equipos e impresoras.","Conexiones de redes.","Instalaciones de programas, antivirus y configuración.",);
...
"Migración de datos.","Instalación de imagen corporativa.","Instalación de programas homologados.",);
...
let experiencia8 = new Expereincia("01/2023","Actualidad","Reparacion Celular & Pcs (forma particular).","Dectecion de fallas.","Cambio de componentes defectuoso.","Instalcion de software.",
);
